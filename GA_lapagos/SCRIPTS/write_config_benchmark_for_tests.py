...
benchmark_name = file_details[running_parser]
running_parser += 1
...
for i in range(num_crossovers):
    for j in range(num_selectors):
        for k in range(num_file_formats): 
            file_name = bname.rstrip() + "_" + file_details[index_crossovers+i].rstrip() + "_" + file_details[index_selectors+j].rstrip() + "_" + file_details[index_file_formats+k].rstrip() + ".xml"
